...
$sel = "select * from tbl_palpayasam p inner join tbl_devotee d on p.Devotee_id=d.Devotee_id where palpayasam_id=".$_GET["pid"];
  ...
  <div class="invoice-box">
    ...
    <div class="invoice-details">
      <div>
        ...
        <strong>Date:</strong> <?php echo $row["palpayasam_date"]?>
      </div>
      <div>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td><?php echo $row["palpayasam_qty"]?></td>
          <!-- <td>$100.00</td> -->
        ...
        <tr class="total">
          ...
          <td><strong><?php echo $row["palpayasam_price"]?></strong></td>
        </tr>
      </tbody>
    </table>
