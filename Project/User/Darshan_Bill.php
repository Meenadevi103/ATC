...
$sel = "select * from tbl_darshan p inner join tbl_devotee d on p.Devotee_id=d.Devotee_id where darshan_id=".$_GET["daid"];
  ...
  <div class="invoice-box">
    ...
    <div class="invoice-details">
      <div>
        ...
        <strong>Date:</strong> <?php echo $row["darshan_date"]?>
      </div>
      <div>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td><?php echo $row["darshan_count"]?></td>
          <!-- <td>$100.00</td> -->
          <td><?php echo $row["darshan_amount"]?></td>
        </tr>
        <!-- <tr class="total">
        ...
        <tr class="total">
          ...
          <td><strong><?php echo $row["darshan_amount"]?></strong></td>
        </tr>
      </tbody>
    </table>
