...
<!-- <div class="container">
    ...
    <table>
        <tr>
            <td colspan="2"><a href="Myprofile.php">My Profile</a></td>
        </tr>
        <tr>
            <td><a href="MarriageBooking.php">Marriage Booking</a></td>
            <td><a href="MyMarriageBooking.php">My Marriage</a></td>
        </tr>
        <tr>
            <td><a href="DarshanBooking.php">Darshan Booking</a></td>
            <td><a href="MyDarshanBooking.php">My Darshan</a></td>
        </tr>
        <tr>
            <td><a href="VazhipadBooking.php">Vazhipad Booking</a></td>
            <td><a href="MyVazhipad.php">My Vazhipad</a></td>
        </tr>
        <tr>
            <td colspan="2"><a href="PalpayasamBooking.php">My Palpayasam</a></td>
        </tr>
        <tr>
            <td colspan="2"><a href="Donation.php">My Donation</a></td>
        </tr>
        <tr>
            <td colspan="2"><a href="PostComplaint.php">Complaints</a></td>
        </tr>
        <tr>
            <td colspan="2"><a href="Feedback.php">Feedback</a></td>
        </tr>
        <tr>
            <td colspan="2"><a href="../Guest/Login.php">Logout</a></td>
        </tr>
    </table>
</div> -->
...
<head>
    ...
    <style>
        /* Remove default button styles for the dropdown */
        /* .dropdown-toggle {
            color: black; /* Plain text color */
        ...
        /* Style for dropdown menu and plain text */
        .dropdown-menu {
            padding: 10px;
    ...
    background-color: #d8f5f8f2;
        ...
        .product {
            background: linear-gradient(rgb(10 189 212 / 16%), rgb(10 189 212 / 16%)), url(../img/) left bottom no-repeat;;
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    ...
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn">Ambalapuzha Sree Krishna Swamy
                                        Temple</h1>
                ...
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <p class="mb-0">The Ambalapuzha Sree Krishna Swamy Temple, located in the serene town of
                                Ambalapuzha in Kerala, is a revered Hindu temple dedicated to Lord Krishna. Known for
                                its deep spiritual significance, the temple draws thousands of devotees each year who
                                seek the blessings of Lord Krishna, depicted here as a child (Balagopala). The temple is
                                renowned for its traditional architecture, rich history, and vibrant annual festivals
                                such as the Ambalapuzha Arattu. One of its most cherished offerings is the famous
                                Palpayasam, a sweet rice pudding said to have been blessed by the deity himself. Steeped
                                in legend and cultural importance, the temple continues to be a spiritual hub for both
                                pilgrims and tourists alike, embodying the grace and charm of Kerala's religious
                                heritage.</p>
                        </div>
                    </div>
        ...
        <div class="container-fluid product py-5 my-5">
            <div class="container py-5">
                ...
                <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                    <a href="DarshanBooking.php" class="d-block product-item rounded">
                        <img src="../Assets/Templates/Main/img/darshan.jpg" class="img-cls" alt="">
                        <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                            <h4 class="text-primary">Darshan Booking</h4>
                            <span class="text-body">"Click here to book your Darshan at Ambalapuzha Sree Krishna
                                Temple."</span>
                        </div>
                    </a>
                    <a href="MarriageBooking.php" class="d-block product-item rounded">
                        <img src="../Assets/Templates/Main/img/marriage.jpg" class="img-cls" alt="">
                        <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                            <h4 class="text-primary">Marriage Booking</h4>
                            <span class="text-body">"Click here to book your marriage ceremony at Ambalapuzha Sree
                                Krishna Temple."</span>
                        </div>
                    </a>
                    <a href="PalpayasamBooking.php" class="d-block product-item rounded">
                        <img src="../Assets/Templates/Main/img/palpayasam.webp" class="img-cls" alt="">
                        <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                            <h4 class="text-primary">Palpaysam Booking</h4>
                            <span class="text-body">"Click here to book Palpayasam offering at Ambalapuzha Sree Krishna
                                Temple."</span>
                        </div>
                    </a>
                    <a href="VazhipadBooking.php" class="d-block product-item rounded">
                        <img src="../Assets/Templates/Main/img/vazhipaad.png" class="img-cls" alt="">
                        <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                            <h4 class="text-primary">Vazhipaad Booking</h4>
                            <span class="text-body">"Click here to book your Vazhipaad offering at Ambalapuzha Sree
                                Krishna Temple.</span>
                        </div>
                    </a>
                </div>
...
<!-- {                        <p class="fs-5 fw-medium fst-italic text-primary">Featured Acticle</p>} -->
    ...
    Video End} -->
            ...
            <div class="container py-5">
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <!-- <div class="testimonial-item p-4 p-lg-5">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <img class="img-fluid flex-shrink-0" src="../Assets/Templates/Main/img/testimonial-2.jpg"
                                alt="">
                            <div class="text-start ms-3">
                                <h5>Client Name</h5>
                    ...
                    <div class="testimonial-item p-4 p-lg-5">
                        <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et
                            lorem et sit, sed stet lorem sit clita duo justo</p>
                        <div class="d-flex align-items-center justify-content-center">
                            <img class="img-fluid flex-shrink-0" src="../Assets/Templates/Main/img/testimonial-3.jpg"
                                alt="">
                            <div class="text-start ms-3">
                                <h5>Client Name</h5>
                                <span class="text-primary">Profession</span>
        ...
        <div class="container-xxl contact py-5">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12901.033951876905!2d76.35478066478667!3d9.377151228364484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b089c0950e73123%3A0x6046787454f7d4b0!2sSree%20Krishna%20Swamy%20Temple%2C%20Ambalapuzha!5e0!3m2!1sen!2sin!4v1727959492346!5m2!1sen!2sin"
