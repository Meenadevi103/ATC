...
$sel = "select * from tbl_marriage p inner join tbl_devotee d on p.Devotee_id=d.Devotee_id where marriage_id=".$_GET["mid"];
  ...
  <div class="invoice-box">
    ...
    <div class="invoice-details">
      <div>
        ...
        <strong>Date:</strong> <?php echo $row["marriage_date"]?>
      </div>
      <div>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td><?php echo $row["marriage_groom"]?></td>
        ...
        <tr class="total">
          ...
          <td><strong><?php echo $row["marriage_amount"]?></strong></td>
        </tr>
      </tbody>
    </table>
